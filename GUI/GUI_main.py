...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.right_news_lable = QtWidgets.QLabel("Local News")
        self.right_news_lable.setObjectName('right_lable')

        self.right_playlist_lable = QtWidgets.QLabel("Real-time weather")
        self.right_playlist_lable.setObjectName('right_lable')

        self.right_news_widget = QtWidgets.QWidget()  # Local news part
        self.right_news_layout = QtWidgets.QGridLayout()
        ...
        self.right_news_layout.addWidget(self.news_button_1, 0, 1, )
        self.right_news_layout.addWidget(self.news_button_2, 1, 1, )
        self.right_news_layout.addWidget(self.news_button_3, 2, 1, )
        self.right_news_layout.addWidget(self.news_button_4, 3, 1, )
        self.right_news_layout.addWidget(self.news_button_5, 4, 1, )
        ...
        self.right_layout.addWidget(self.right_news_lable, 4, 0, 1, 5)
        self.right_layout.addWidget(self.right_playlist_lable, 4, 5, 1, 4)
        self.right_layout.addWidget(self.right_news_widget, 5, 0, 1, 5)
        ...
        #mapfunction
        self.function_button_2.clicked.connect(lambda:self.open_map())
